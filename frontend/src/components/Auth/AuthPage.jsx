...
export const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 flex items-center justify-center px-4">
      <div className="max-w-6xl mx-auto grid lg-cols-2 gap-12 items-center">
        <motion.div
        ...
        >
          <div className="space-y-4">
            ...
            <h2 className="text-3xl lg-4xl font-bold text-gray-900">
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus-2 focus-purple-500 focus-transparent"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus-2 focus-purple-500 focus-transparent"
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-lg font-semibold hover-purple-700 hover-blue-700 transition-all disabled-50 disabled-not-allowed"
              >
                {loading ? (
              ...
              {authMode === 'signin' && (
                <div className="space-y-2">
                  <button
                    ...
                    className="text-purple-600 hover-purple-700 font-medium"
                  >
              ...
              <>
                ...
                <div className="space-y-3">
                  <motion.button
                    ...
                    className="w-full flex items-center justify-center space-x-3 bg-white border border-gray-300 rounded-lg px-6 py-3 text-gray-700 hover-gray-50 transition-all duration-200 shadow-sm"
                  >
                  ...
                  <motion.button
                    ...
                    className="w-full flex items-center justify-center space-x-3 bg-gray-900 text-white rounded-lg px-6 py-3 hover-gray-800 transition-all duration-200 shadow-sm"
                  >

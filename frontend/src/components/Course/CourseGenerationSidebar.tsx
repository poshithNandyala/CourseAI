...
export const CourseGenerationSidebar: React.FC<CourseGenerationSidebarProps> = ({
  isVisible,
  courseTitle,
  mainTopic,
  subtopics,
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed right-4 top-4 bottom-4 w-80 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 z-50 flex flex-col overflow-hidden"
        >
          {/* Header */}
            ...
            <div className="space-y-2">
              {steps.map((step, index) => (
                <motion.div
                  ...
                  className={`p-3 rounded-lg border transition-all duration-200 ${getStepColor(step)}`}
                >

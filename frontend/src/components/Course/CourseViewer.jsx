...
export const CourseViewer = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark-white mb-2">
            Course not found
          </h2>
          <p className="text-gray-600 dark-gray-400 mb-6">
            The course you're looking for doesn't exist or you don't have access
            to it.
          </p>
          <button
            onClick={() => navigate("/dashboard")}
            className="bg-gradient-to-r from-brand-500 to-accent-500 text-white px-6 py-3 rounded-xl hover-brand-600 hover-accent-600 transition-all duration-200"
          >
            Back to Dashboard
          </button>
        </div>
  ...
  console.log("🎬 Current lesson video status:", {
    ...
    hasVideos,
    videoCount: videoCount?.video_data?.length || 0,
    firstVideoTitle: firstVideoTitle?.video_data?.[0]?.title,
  });
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      >
        ...
        <div className="bg-white dark-gray-900 rounded-3xl p-8 shadow-soft border border-gray-200 dark-gray-800">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-gray-900 dark-white mb-3">
                {course.title}
              </h1>
              <p className="text-gray-600 dark-gray-400 text-lg mb-4">
                {course.description}
              </p>

              <div className="flex items-center space-x-6 text-sm text-gray-500 dark-gray-400">
            ...
            <div className="ml-6">
              <span
                className={`px-3 py-1 rounded-full text-sm font-medium ${
                  course.is_published
                    ? "bg-success-100 dark-success-900/30 text-success-700 dark-success-400"
                    : "bg-warning-100 dark-warning-900/30 text-warning-700 dark-warning-400"
                }`}
              >
      ...
      {/* Navigation Tabs */}
      <div className="bg-white dark-gray-900 rounded-3xl shadow-soft border border-gray-200 dark-gray-800 overflow-hidden mb-8">
        <div className="flex border-b border-gray-200 dark-gray-800">
          {[
            { id: "overview", label: "Course Overview", icon },
            { id: "lessons", label: "Lessons & Videos", icon },
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center space-x-2 px-6 py-4 font-medium transition-all duration-200 ${
                activeTab === tab.id
                  ? "bg-brand-50 dark-brand-900/30 text-brand-600 dark-brand-400 border-b-2 border-brand-500"
                  : "text-gray-600 dark-gray-400 hover-gray-900 dark-gray-100 hover-gray-50 dark-gray-800"
              }`}
            >
        ...
        <div className="p-8">
          {activeTab === "overview" && (
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-900 dark-white">
                Course Structure
              </h3>

              {/* Video Status Summary */}
              <div className="bg-blue-50 dark-blue-900/20 rounded-2xl p-4 border border-blue-200 dark-blue-800">
                <div className="flex items-center space-x-3">
                  <Youtube className="h-5 w-5 text-red-500" />
                  <div>
                    <h4 className="font-medium text-blue-900 dark-blue-100">
              ...
              <div className="grid gap-4">
                {lessons.map((lesson, index) => (
                  <div
                    key={lesson.id}
                    className="flex items-center space-x-4 p-4 bg-gray-50 dark-gray-800 rounded-2xl"
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <div className="p-1 rounded bg-blue-100 dark-blue-900/30 text-blue-600 dark-blue-400">
                          <FileText className="h-4 w-4" />
                        </div>
                        <h4 className="font-semibold text-gray-900 dark-white">
                          {lesson.title}
                        </h4>
                        {lesson.video_data && lesson.video_data.length > 0 && (
                          <div className="flex items-center space-x-1 bg-red-100 dark-red-900/30 text-red-600 dark-red-400 px-2 py-1 rounded-full text-xs">
                            <Youtube className="h-3 w-3" />
                            <span>{lesson.video_data.length} videos</span>
                          </div>
                        )}
                      </div>
                      <p className="text-gray-600 dark-gray-400 text-sm">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-brand-500 text-white rounded-lg hover-brand-600 transition-colors duration-200"
                    >
                      View
                    </button>
                  </div>
          ...
          {activeTab === "lessons" && (
            <div className="space-y-8">
              ...
              {selectedLesson && (
                <div className="space-y-6">
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 dark-white mb-2">
                  ...
                  {/* Lesson Content */}
                  <div className="bg-gray-50 dark-gray-800 rounded-2xl p-6">
                    <div className="prose dark-invert max-w-none">
                  ...
                  {hasVideos ? (
                    <div>
                      <h4 className="text-lg font-semibold text-gray-900 dark-white mb-4 flex items-center space-x-2">
                        <Youtube className="h-5 w-5 text-red-500" />
                        <span>
                          Real YouTube Videos (
                    ...
                    <div className="text-center py-8 bg-yellow-50 dark-yellow-900/20 rounded-2xl border border-yellow-200 dark-yellow-800">
                      <AlertCircle className="h-12 w-12 text-yellow-500 mx-auto mb-3" />
                      <h4 className="font-semibold text-yellow-800 dark-yellow-200 mb-2">
                        No Videos Available
                      </h4>
                      <p className="text-yellow-700 dark-yellow-300">
                        No video content was found for this lesson. This might
                        be due to:
                      </p>
                      <ul className="text-sm text-yellow-600 dark-yellow-400 mt-2 space-y-1">
                        <li>
            ...
            <div className="space-y-8">
              ...
              {hasQuizQuestions ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 dark-white mb-2">
                    No Quiz Available
                  </h3>
                  <p className="text-gray-600 dark-gray-400 mb-4">

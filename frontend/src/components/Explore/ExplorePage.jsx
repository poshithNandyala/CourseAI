...
export const ExplorePage = () => {
  ...
  const handleLikeCourse = async (courseId, event) => {
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Discover amazing courses created by our community - accessible to
            everyone!
          </p>
        </motion.div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start justify-between">
                      ...
                      <button
                        ...
                        className={`ml-2 p-2 rounded-full transition-all duration-200 ${likedCourses.has(course.id)
                            ? "text-red-500 bg-red-50 dark:bg-red-900/20"
                            : "text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20"
                          }`}
                      >
                        <Heart
                          className={`h-5 w-5 ${likedCourses.has(course.id) ? "fill-current" : ""
                            }`}
                        />
                      </button>
                    </div>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
                      <span className="flex items-center space-x-1">
                        ...
                        <span>
                          {course.rating.toFixed(1)} ({course.ratings_count})
                        </span>
                      </span>
                      <span className="flex items-center space-x-1">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`px-2 py-1 text-xs rounded-full font-medium ${course.difficulty === "beginner"

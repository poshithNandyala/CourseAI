...
const ProfessionalSettings = () => {
  ...
  const handleSaveApiKeys = async (keyType) => {
    let keysToSave = {};
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (keyType === 'gemini') {
          ...
          setEditingKeys(prev => ({ ...prev, gemini }));
        } else if (keyType === 'youtube') {
          setApiKeys(prev => ({ ...prev, youtubeApiKey: '' }));
          setEditingKeys(prev => ({ ...prev, youtube }));
        } else {
          setApiKeys({ geminiApiKey: '', youtubeApiKey: '' });
          setEditingKeys({ gemini, youtube });
        }
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      // Note endpoint needs to be implemented in the backend
  ...
  const getStatusIcon = (apiStatus) => {
    switch (apiStatus.status) {
      ...
      case 'quota_exceeded': return <AlertTriangle className="h-5 w-5 text-yellow-500" />;
  ...
  const getProviderIcon = (provider) => {
    switch (provider) {
      case 'google': return <Chrome className="h-5 w-5 text-blue-500" />;
      case 'github': return <Github className="h-5 w-5 text-gray-800 dark:text-gray-200" />;
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 via-white to-accent-50 dark-gray-900 dark-gray-800 dark-gray-900">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-white to-accent-50 dark:bg-gray-900 dark:from-gray-800 dark:to-gray-900">
              ...
              <AnimatePresence mode="wait">
                      ...
                      <div className="flex items-center space-x-6">
                        <div className="relative">
                          <img
                            ...
                            alt={user.fullname || user.email}
                            className="w-24 h-24 rounded-2xl object-cover ring-4 ring-brand-100 dark-brand-900/30"
                          />
                          {isEditing && (
                            <label className="absolute -bottom-2 -right-2 bg-brand-500 text-white p-2 rounded-xl cursor-pointer hover-brand-600 transition-colors shadow-lg">
                      ...
                      <div className="grid grid-cols-1 md-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            ...
                            disabled={isEditing}
                            className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 focus-2 focus-brand-500 focus-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white disabled-50 disabled-not-allowed"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            disabled={true}
                            className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:border-gray-600 text-gray-500 dark:text-gray-400 cursor-not-allowed"
                          />
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            Email cannot be changed's linked to your authentication
                          </p>
                        </div>
                      </div>
                      ...
                      {isEditing && (
                        <div className="flex items-center space-x-4 pt-6 border-t border-gray-200 dark:border-gray-600">
                          <button
                            ...
                            disabled={saving}
                            className="flex items-center space-x-2 px-6 py-3 bg-brand-500 text-white rounded-xl font-medium hover-brand-600 disabled-50 disabled-not-allowed transition-colors"
                          >
                ...
                {activeTab === 'api-keys' && (
                  ...
                  >
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                  {apiKeysStatus.gemini.status === 'valid' ? 'Valid & Active' : apiKeysStatus.gemini.status === 'invalid' ? 'Invalid Key' : apiKeysStatus.gemini.status === 'quota_exceeded' ? 'Quota Exceeded' : 'Not Configured'}
                                </p>
                              </div>
                          ...
                          <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4">
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                  {apiKeysStatus.youtube.status === 'valid' ? 'Valid & Active' : apiKeysStatus.youtube.status === 'invalid' ? 'Invalid Key' : apiKeysStatus.youtube.status === 'quota_exceeded' ? 'Quota Exceeded' : 'Not Configured'}
                                </p>
                              </div>
                    ...
                    <div className="mb-8">
                      ...
                      <div className="grid grid-cols-1 md-cols-2 gap-6">
                        <div className="bg-blue-50 dark-blue-900/20 rounded-xl p-4">
                          <h4 className="font-medium text-blue-900 dark-blue-100 mb-2 flex items-center space-x-2">
                            <span>🧠</span>
                            <span>Gemini AI API Key</span>
                          </h4>
                          <ol className="text-sm text-blue-800 dark-blue-200 space-y-1">
                        ...
                        <div className="bg-red-50 dark-red-900/20 rounded-xl p-4">
                          <h4 className="font-medium text-red-900 dark-red-100 mb-2 flex items-center space-x-2">
                            <span>📺</span>
                            <span>YouTube Data API Key</span>
                          </h4>
                          <ol className="text-sm text-red-800 dark-red-200 space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center space-x-3">
                            <div className="p-2 bg-blue-100 dark-blue-900/30 rounded-lg">
                              <Key className="h-4 w-4 text-blue-600 dark-blue-400" />
                            </div>
                            <div>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            {editingKeys.gemini && apiKeysStatus?.gemini.configured && (
                              <button
                                onClick={() => setEditingKeys(prev => ({ ...prev, gemini }))}
                                className="p-2 text-gray-400 hover-gray-600 dark-gray-300"
                              >
                                <Edit3 className="h-4 w-4" />
                              </button>
                            )}
                        ...
                        {apiKeysStatus?.gemini.configured || editingKeys.gemini ? (
                          <div className="space-y-3">
                            <div className="relative">
                              <input
                                ...
                                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus-2 focus-brand-500 focus-transparent dark:border-gray-600 dark:text-white pr-12"
                              />
                              <button
                                type="button"
                                onClick={() => setShowKeys(prev => ({ ...prev, gemini: prev.gemini }))}
                                className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover-gray-600 dark-gray-300"
                              >
                            ...
                            <div className="flex space-x-2">
                              <button
                                ...
                                className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover-blue-700 disabled-50 disabled-not-allowed transition-colors"
                              >
                              ...
                              {editingKeys.gemini && (
                                <button
                                  ...
                                  className="px-4 py-2 text-gray-600 dark:text-gray-400 hover-gray-800 dark-gray-200"
                                >
                                  Cancel
                                </button>
                              )}
                          ...
                          <div className="text-sm text-gray-500 dark:text-gray-400">
                            Key configured and {apiKeysStatus.gemini.status === 'valid' ? 'valid & active' : apiKeysStatus.gemini.status === 'invalid' ? 'invalid' : apiKeysStatus.gemini.status === 'quota_exceeded' ? 'quota exceeded' : 'not configured'}
                          </div>
                        )}
                      </div>
                      ...
                      <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center space-x-3">
                            <div className="p-2 bg-red-100 dark-red-900/30 rounded-lg">
                              <Key className="h-4 w-4 text-red-600 dark-red-400" />
                            </div>
                            <div>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            {editingKeys.youtube && apiKeysStatus?.youtube.configured && (
                              <button
                                onClick={() => setEditingKeys(prev => ({ ...prev, youtube }))}
                                className="p-2 text-gray-400 hover-gray-600 dark-gray-300"
                              >
                                <Edit3 className="h-4 w-4" />
                              </button>
                        ...
                        {apiKeysStatus?.youtube.configured || editingKeys.youtube ? (
                          <div className="space-y-3">
                            ...
                            <div className="flex space-x-2">
                              <button
                                ...
                                className="flex-1 bg-red-600 text-white px-4 py-2 rounded-lg hover-red-700 disabled-50 disabled-not-allowed transition-colors"
                              >
                          ...
                          <div className="text-sm text-gray-500 dark:text-gray-400">
                            Key configured and {apiKeysStatus.youtube.status === 'valid' ? 'valid & active' : apiKeysStatus.youtube.status === 'invalid' ? 'invalid' : apiKeysStatus.youtube.status === 'quota_exceeded' ? 'quota exceeded' : 'not configured'}
                          </div>
                        )}
                      </div>
                      ...
                      {apiKeysStatus && apiKeysStatus.gemini.status === 'valid' && apiKeysStatus.youtube.status === 'valid' && (
                        <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark-green-900/20 dark-emerald-900/20 border border-green-200 dark-green-800 rounded-xl p-6">
                          <div className="flex items-center space-x-3">
                            <CheckCircle className="h-6 w-6 text-green-600 dark-green-400" />
                            <div>
                              <h4 className="font-semibold text-green-900 dark-green-100">All Set</h4>
                              <p className="text-green-700 dark-green-300">
                          ...
                          <button
                            ...
                            className="mt-4 inline-flex items-center space-x-2 bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover-green-700 transition-colors"
                          >
                ...
                {activeTab === 'security' && (
                  ...
                  >
                    ...
                    {user?.auth_provider === 'local' ? (
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                          ...
                          <div className="space-y-4">
                            ...
                            <button
                              ...
                              className="w-full bg-brand-500 text-white px-6 py-3 rounded-lg font-medium hover-brand-600 disabled-50 disabled-not-allowed transition-colors"
                            >
                      ...
                      <div className="bg-blue-50 dark-blue-900/20 border border-blue-200 dark-blue-800 rounded-xl p-6">
                        <div className="flex items-center space-x-3">
                          {getProviderIcon(user?.auth_provider || 'local')}
                          <div>
                            <h3 className="font-semibold text-blue-900 dark-blue-100">OAuth Account</h3>
                            <p className="text-blue-700 dark-blue-300">
                ...
                {activeTab === 'danger' && (
                  ...
                  >
                    ...
                    <div className="bg-red-50 dark-red-900/20 border-2 border-red-200 dark-red-800 rounded-xl p-6">
                      <div className="flex items-start space-x-4">
                        <div className="bg-red-100 dark-red-900/30 p-3 rounded-xl">
                          <Trash2 className="h-6 w-6 text-red-600 dark-red-400" />
                        </div>
                        <div className="flex-1">
                          <h3 className="text-lg font-semibold text-red-900 dark-red-100 mb-2">
                            Delete Account
                          </h3>
                          <p className="text-red-700 dark-red-300 mb-4">
                            Permanently delete your account and all associated data. This action cannot be undone.
                          </p>
                          <ul className="text-sm text-red-600 dark-red-400 mb-6 space-y-1">
                          ...
                          <button
                            ...
                            disabled={saving}
                            className="bg-red-600 text-white px-6 py-3 rounded-lg font-medium hover-red-700 disabled-50 disabled-not-allowed transition-colors"
                          >

...
const Settings = () => {
  ...
  const handleSaveApiKeys = async (keyType?: 'gemini' | 'youtube') => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api-keys/update`, {
        ...
        credentials: 'include',
        body.stringify(keysToSave)
      });

      const result = await response.json();
      
      if (response.ok) {
        const keyName = keyType === 'gemini' ? 'Gemini'  === 'youtube' ? 'YouTube' : 'API';
  ...
  const getStatusIcon = (apiStatus) => {
    switch (apiStatus.status) {
      case 'valid' <CheckCircle className="h-5 w-5 text-green-500" />;
      case 'invalid' <XCircle className="h-5 w-5 text-red-500" />;
      case 'quota_exceeded' <AlertTriangle className="h-5 w-5 text-yellow-500" />;
      default <AlertTriangle className="h-5 w-5 text-gray-400" />;
    }
  };

  const getStatusText = (apiStatus) => {
    switch (apiStatus.status) {
      case 'valid' 'Valid & Active';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark-gray-900 dark-gray-800 dark-gray-900">
      <div className="max-w-4xl mx-auto py-12 px-4 sm-6 lg-8">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-white dark-gray-800 rounded-2xl shadow-xl overflow-hidden"
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6">
            <div className="flex items-center justify-between">
              ...
              {location.state?.from && (
                <button
                  onClick={() => navigate(-1)}
                  className="flex items-center space-x-2 text-white hover-indigo-200 transition-colors"
                >
          ...
          <div className="p-8">
            ...
            {status && (
              <motion.div
                ...
                className="mb-8"
              >
                <h2 className="text-lg font-semibold text-gray-900 dark-white mb-4">Current Status</h2>
                <div className="grid grid-cols-1 md-cols-2 gap-4">
                  <div className="bg-gray-50 dark-gray-700 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-medium text-gray-900 dark-white">Gemini AI API</h3>
                        <p className="text-sm text-gray-500 dark-gray-400">{getStatusText(status.gemini)}</p>
                      </div>
                  ...
                  <div className="bg-gray-50 dark-gray-700 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-medium text-gray-900 dark-white">YouTube Data API</h3>
                        <p className="text-sm text-gray-500 dark-gray-400">{getStatusText(status.youtube)}</p>
                      </div>
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h2 className="text-lg font-semibold text-gray-900 dark-white mb-4">Setup Instructions</h2>
              <div className="grid grid-cols-1 md-cols-2 gap-6">
                {/* Gemini Setup */}
                <div className="bg-blue-50 dark-blue-900/20 rounded-lg p-4">
                  <h3 className="font-medium text-blue-900 dark-blue-100 mb-2">🧠 Gemini AI API Key</h3>
                ...
                {/* YouTube Setup */}
                <div className="bg-red-50 dark-red-900/20 rounded-lg p-4">
                  <h3 className="font-medium text-red-900 dark-red-100 mb-2">📺 YouTube Data API Key</h3>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-lg font-semibold text-gray-900 dark-white mb-4">Manage API Keys</h2>
              
              {/* Gemini API Key */}
              <div className="bg-gray-50 dark-gray-700 rounded-xl p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900 dark-white">Gemini AI API Key</h3>
                      <p className="text-sm text-gray-500 dark-gray-400">
                  ...
                  <div className="space-y-3">
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-300 dark-gray-600 rounded-lg focus-2 focus-indigo-500 focus-transparent dark-gray-700 dark-white pr-12"
                      />
                      <button
                        type="button"
                    ...
                    <div className="flex space-x-2">
                      ...
                      {editingKeys.gemini && (
                        <button
                          ...
                          className="px-4 py-2 text-gray-600 dark-gray-400 hover-gray-800 dark-gray-200"
                        >
                          Cancel
                        </button>
                      )}
              ...
              <div className="bg-gray-50 dark-gray-700 rounded-xl p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-900 dark-white">YouTube Data API Key</h3>
                      <p className="text-sm text-gray-500 dark-gray-400">
              ...
              {status && (status.gemini.configured || status.youtube.configured) && (
                <div className="pt-6 border-t border-gray-200 dark-gray-600">
                  <div className="flex flex-col sm-row gap-4">
                    {status.gemini.configured && status.youtube.configured && (
                      <button
                        onClick={() => navigate('/create')}
                        className="flex-1 flex items-center justify-center space-x-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium hover-indigo-700 hover-purple-700 transition-all duration-200"
                      >
                    ...
                    <motion.button
                      ...
                      className="flex-1 sm-none flex items-center justify-center space-x-2 bg-red-600 text-white px-6 py-3 rounded-lg font-medium hover-red-700 transition-all duration-200"
                    >
            ...
            <motion.div
              ...
              className="mt-8 bg-yellow-50 dark-yellow-900/20 rounded-lg p-4"
            >
              <h3 className="font-medium text-yellow-900 dark-yellow-100 mb-2">⚠️ Important Notes</h3>
              <ul className="text-sm text-yellow-800 dark-yellow-200 space-y-1">

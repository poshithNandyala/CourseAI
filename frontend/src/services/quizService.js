...
class QuizService {
  ...
  private getQuestionDifficulty(index, total, courseDifficulty): 'easy' | 'medium' | 'hard' {
  ...
  private generateQuestionByType(
    ...
    switch (type) {
      case 'definition' this.generateDefinitionQuestion(questionId, topic, subtopic, keyPoints, difficulty);
      case 'application' this.generateApplicationQuestion(questionId, topic, subtopic, keyPoints, difficulty);
      case 'comparison' this.generateComparisonQuestion(questionId, topic, subtopic, keyPoints, difficulty);
      case 'analysis' this.generateAnalysisQuestion(questionId, topic, subtopic, keyPoints, difficulty);
      case 'synthesis' this.generateSynthesisQuestion(questionId, topic, subtopic, keyPoints, difficulty);
      case 'evaluation' this.generateEvaluationQuestion(questionId, topic, subtopic, keyPoints, difficulty);
      default this.generateDefinitionQuestion(questionId, topic, subtopic, keyPoints, difficulty);
    }
  }
  ...
  private generateDefinitionQuestion(
    ...
    if (difficulty === 'easy') {
      ...
      return {
        ...
        explanation: `${subtopic} serves foundational component in ${topic}, connecting with and influencing various other areas within the field.`,
        difficulty
      };
    } else {
      return {
    ...
    if (difficulty === 'easy') {
      ...
      return {
        ...
        options: [
          ...
          'Never, approaches are always better',

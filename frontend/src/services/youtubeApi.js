...
// id, title, description, duration, thumbnailUrl, channelTitle, publishedAt, viewCount, embedUrl

// YouTubeSearchParams interface:
// query, maxResults (optional), order (optional), duration (optional)
...
class YouTubeAPIService {
  ...
  async searchVideos(params) {
    ...
    try {
      ...
      console.warn(
        "User's YouTube API key not configured, using mock data. Error:",
        error
      );
      ...
      react: [
        {
          ...
          description:
            "Learn React from scratch in this comprehensive tutorial. Perfect for beginners who want to master React fundamentals.",
          duration: "2:25:00",
          thumbnailUrl:
        ...
        },
        {
          ...
          duration: "38:30",
          thumbnailUrl:
            "https://img.youtube.com/vi/O6P86uwfdR0/maxresdefault.jpg",
      ...
      javascript: [
        {
          ...
          description:
            "Complete JavaScript course covering all fundamentals and advanced concepts.",
          duration: "3:26:00",
          thumbnailUrl:
        ...
        },
        {
          ...
          description:
            "Master asynchronous JavaScript with promises, async/await, and more.",
          duration: "45:30",
          thumbnailUrl:
            "https://img.youtube.com/vi/PoRJizFvM7s/maxresdefault.jpg",
          channelTitle: "Dev Ed",
      ...
      python: [
        {
          ...
          description:
            "Complete Python programming course for absolute beginners. Learn Python from scratch.",
          duration: "6:14:00",
          thumbnailUrl:
  ...
  async getVideoDetails(videoId) {
    ...
    try {
      ...
      console.warn("User's YouTube API key not configured");
      return null;
    }
